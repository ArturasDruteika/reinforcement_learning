...
class LunarLanderDQNAgent:
    ...
    def shuffle(self) -> bool:
        """bool: Whether replay memory is shuffled."""
    ...
    def learning_step(self) -> int:
        """int: Current number of learning steps."""
        return self.__learning_step
    
    @property
    def model(self) -> LunarLanderCNN:
        """LunarLanderCNN: The Q-network model."""
        return self.__model
    
    @property
    def target_model(self) -> LunarLanderCNN:
        """LunarLanderCNN: The target Q-network model."""
        return self.__target_model
    
    @property
    def optimizer(self) -> optim.Adam:
        """optim.Adam: The optimizer for the Q-network."""
        return self.__optimizer
    
    @property
    def criterion(self) -> nn.SmoothL1Loss:
        """nn.SmoothL1Loss: The loss function."""
    ...
    def update_target_model(self) -> None:
        """Synchronize the target model with the current Q-network."""
        self.__target_model.load_state_dict(self.__model.state_dict())
